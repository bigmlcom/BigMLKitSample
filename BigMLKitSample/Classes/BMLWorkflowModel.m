...
@implementation BMLWorkflowModel {
    ...
    NSString* _workflowInitialTask;
    NSString* _workflowEndTask;
    BMLResourceType* _target;
}
...
- (NSArray*)workflowTasks {
    ...
    NSMutableArray* types = [@[kSourceEntityType,
                               kDatasetEntityType,
                               (_target == kModelTarget)?kModelEntityType:kClusterEntityType,
                               kPredictionEntityType] mutableCopy];
    
    NSInteger initialIndex = [types indexOfObject:_workflowInitialTask];
    ...
    NSInteger finalIndex = [types indexOfObject:_workflowEndTask];
...
- (void)configureWorkflowForResource:(NSDictionary*)resource {
    ...
    _workflowInitialTask = resourceType;
